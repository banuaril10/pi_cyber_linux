	...
	<div class="col-12">
		<div class="card">
			<div class="card-header">
				<h4>HARGA REGULER BABY DOLL <?php echo $_GET['rak']; ?></h4> <button type="button" class="btn btn-primary" id="sync" onclick="syncMaster();">Sync Rack</button>
			</div>
			<div class="card-body">
			<div class="tables">			
...
<script src="styles/js/price-babydoll.js"></script>
<script>
